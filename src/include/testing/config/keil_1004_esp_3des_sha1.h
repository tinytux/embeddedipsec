/** @file keil_1004_esp_3des_sha1.h
 *  @brief Test configuration: ESP 3DES SHA1 connection between FreeS/WAN host (192.168.1.5) and Keil MCB167NET board (192.168.1.3)
 */
