/** @file phy_netconfig.h
 *  @brief Test configuration: connection between any host and PhyCORE167-HS/E board (192.168.1.4) - dynamic SAD/SPD configuration over UDP port 500 ("ISAKMP light")
 */
